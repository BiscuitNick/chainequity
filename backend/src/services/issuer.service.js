...
export class IssuerService {
     ...
     */
    constructor(serviceConfig, retryConfig = DEFAULT_RETRY_CONFIG) {
        ...
        this.contract = new ethers.Contract(serviceConfig.contractAddress, ChainEquityTokenABI, this.wallet);
     ...
     */
    async isWalletApproved(address) {
        if (!alchemyUtils.isValidAddress(address)) {
            throw new Error(`Invalid address: ${address}`);
        }
     ...
     * @returns Transaction receipt
     */
    async executeSplit(multiplierBasisPoints) {
