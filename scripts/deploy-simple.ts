...
async function main() {
  ...
  try {
    ...
    // Test transfer
    console.log('\n🔄 Testing transfer...');
    const tokenAsAddr1 = await hre.viem.getContractAt('ChainEquityToken', token.address, {
      client: { wallet: addr1 },
    });
    ...
    console.log(
      `   npm run test-issuer -- ${token.address} 0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80`
    );
    console.log('');
  } catch (error) {
